...
<title>Viewing All Pending Requests</title>
...
<h1 class="shao_yellow">Viewing All Pending Requests</h1>
...
%>
<!-- count to dynamicly make names for form -->
<c:set var="count" scope="session" value="${0}"/>

<c:set var="s" value="status"/>
	
	<c:out value="${s}"/>

<form method="POST" action="UpdateReimbursement">
...
<table id="example" class=".table">
	...
	<c:forEach var="item" items="${pend_list}">
