...
<title>Viewing All Resolved Requests</title>
...
<h1 class="shao_yellow">Viewing All Resolved Requests</h1>

	
<table id="example" class=".table"s>
	
	<tr>
		<th class="col1">Id</th>
		<th class="col2">Amount</th>
		<th class="col3">Description</th>
		<th class="col4">Submitted</th>
		<th class="col5">Resolved</th>
		<th class="col6">Author</th>
		<th class="col7">Resolver</th>
		<th class="col8">Type</th>
		<th class="col9">Status</th>
		<th class="col10">View Image</th>
	</tr>
	
	<!--  item is reimbursement -->
	<c:forEach var="item" items="${resolved_list}">
   	<TR>
	    <TD>${item.getId()}</TD>
